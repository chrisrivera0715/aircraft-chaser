 ...
 if(aircraft.maxHealth<aircraft.health)aircraft.health=aircraft.maxHealth;
        ...
        for(i = 0; i < missiles.length; i++)
        {
            ...
            if(fake_heli ==  null)
            {
                ...
                let xCollide =    missiles[i].position.x <=  aircraft.position.x +                             aircraft.width  && missiles[i].position.x + missiles[i].width >=                           aircraft.position.x;
            ...
            else
            {
                ...
                else
                {
                 ...
                 let xCollide =    missiles[i].position.x <=  fake_heli.position.x +                            fake_heli.width  && missiles[i].position.x + missiles[i].width >=                          fake_heli.position.x;
                let yCollide =    missiles[i].position.y <=  fake_heli.position.y +                              fake_heli.width  && missiles[i].position.y + missiles[i].width >=                          fake_heli.position.y;
                if(xCollide && yCollide)
                {
                    missiles.splice(i, 1);
                  }
